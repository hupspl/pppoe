...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.kompartnadajniki.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.kompartnadajnikis.update", [$kompartnadajniki->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                <label for="name">{{ trans('cruds.kompartnadajniki.fields.name') }}</label>
                <input class="form-control {{ $errors->has('name') ? 'is-invalid' : '' }}" type="text" name="name" id="name" value="{{ old('name', $kompartnadajniki->name) }}">
                @if($errors->has('name'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('ip_user') ? 'is-invalid' : '' }}" type="text" name="ip_user" id="ip_user" value="{{ old('ip_user', $kompartnadajniki->ip_user) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('mac') ? 'is-invalid' : '' }}" type="text" name="mac" id="mac" value="{{ old('mac', $kompartnadajniki->mac) }}">
                @if($errors->has('mac'))
                    <div class="invalid-feedback">
                        {{ $errors->first('mac') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('login') ? 'is-invalid' : '' }}" type="text" name="login" id="login" value="{{ old('login', $kompartnadajniki->login) }}">
                @if($errors->has('login'))
                    <div class="invalid-feedback">
                        {{ $errors->first('login') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('password') ? 'is-invalid' : '' }}" type="text" name="password" id="password" value="{{ old('password', $kompartnadajniki->password) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('date_soft') ? 'is-invalid' : '' }}" type="text" name="date_soft" id="date_soft" value="{{ old('date_soft', $kompartnadajniki->date_soft) }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('notka') ? 'is-invalid' : '' }}" name="notka" id="notka">{!! old('notka', $kompartnadajniki->notka) !!}</textarea>
                @if($errors->has('notka'))
                    <div class="invalid-feedback">
                        {{ $errors->first('notka') }}
                    </div>
